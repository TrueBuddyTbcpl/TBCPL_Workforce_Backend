...
@Entity
@Table(
        name = "proposal_background",
        indexes = @Index(name = "idx_bg_proposal_id", columnList = "proposal_id")
)
@Getter @Setter
@NoArgsConstructor @AllArgsConstructor
@Builder
public class ProposalBackground {
    ...
    @Lob
    @Column(name = "background_text", columnDefinition = "LONGTEXT")
