...
@Entity
@Table(
        name = "proposal_confidentiality",
        indexes = @Index(name = "idx_conf_proposal_id", columnList = "proposal_id")
)
@Getter @Setter
@NoArgsConstructor @AllArgsConstructor
@Builder
public class ProposalConfidentiality {
    ...
    @Lob
    @Column(name = "custom_points_json", columnDefinition = "LONGTEXT")
    private String customPointsJson;
