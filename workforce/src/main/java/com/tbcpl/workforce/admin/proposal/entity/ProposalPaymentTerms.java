...
@Table(
        ...
        indexes = @Index(name = "idx_payment_proposal_id", columnList = "proposal_id")
)
@Getter @Setter
@NoArgsConstructor @AllArgsConstructor
@Builder
public class ProposalPaymentTerms {
    ...
    @Lob
    @Column(name = "payment_terms_text", columnDefinition = "LONGTEXT")
