                          ...
                          <tr>
                            <td style="padding:34px 40px 20px;">
                              ...
                              <p style="margin:0; font-size:14px; color:#4a5568; line-height:1.75;">
                                ...
                                prepared by True Buddy Consulting Pvt. Ltd. The report has been generated
                                as per the details provided and is intended solely for your authorised use.
                              </p>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td style="padding:0 40px 34px;">
                              ...
                              <p style="margin:0 0 2px; font-size:14px; font-weight:600;
                                        color:#0f2340;">Operations Team</p>
                              <p style="margin:0 0 6px; font-size:14px; font-weight:600;
                                        color:#0f2340;">True Buddy Consulting Pvt. Ltd.</p>
